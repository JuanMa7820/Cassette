...
( function( window, $, undefined ) {
	...
	$.Cassette.prototype 	= {
		...
		_createControls		: function() {
			...
			this.$cPlay		= $( '<li class="vc-control-play">Reproducir<span></span></li>' );
			this.$cRewind	= $( '<li class="vc-control-rewind">Regr.<span></span></li>' );
			this.$cForward	= $( '<li class="vc-control-fforward">Avan.<span></span></li>' );
			this.$cStop		= $( '<li class="vc-control-stop">Parar<span></span></li>' );
			this.$cSwitch	= $( '<li class="vc-control-switch">Girar<span></span></li>' );
		...
		_switchSides		: function() {
			...
			if( this.isMoving ) {
				...
				alert( 'Por favor, detén/para el reproductor antes de cambiar de lado' );
				return false;
